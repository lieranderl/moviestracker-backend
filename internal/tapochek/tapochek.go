...
func HttpClientWithCookie() (*http.Client) {
...
func verifyLogin(c *colly.Collector, login, pass string) bool {
	httpClient := HttpClientWithCookie()
	...
	log.Println("LOGIN TAPOCHEK WITH COOKIE")
		coo := &http.Cookie{
		Name: "bb_data", 
		Value: "a%3A3%3A%7Bs%3A2%3A%22uk%22%3Bs%3A12%3A%22gQo1aJb0OyVK%22%3Bs%3A3%3A%22uid%22%3Bi%3A19320%3Bs%3A3%3A%22sid%22%3Bs%3A20%3A%22q9oFxR63hRTO9O3fBoc7%22%3B%7D",
		Domain: ".tapochek.net",
		Path:"/",
	...
	// 	if j.Name == "bb_data" {
	// 		log.Println("LOGIN TAPOCHEK")
	// 		return c.SetCookies("https://tapochek.net", httpClient.Jar.Cookies(u)) == nil
	// 	} else {
	// 		log.Println("LOGIN TAPOCHEK WITH COOKIE")
	// 		coo := &http.Cookie{
	// 			Name: "bb_data", 
